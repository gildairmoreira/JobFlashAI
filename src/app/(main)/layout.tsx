...
import ExpiredModal from "@/components/premium/ExpiredModal";
...
export default async function Layout({
  ...
  const isActuallyExpired = userSub?.currentPeriodEnd && userSub.currentPeriodEnd < new Date() && userSub.planType === "FREE";
  ...
  return (
    <SubscriptionLevelProvider userSubscriptionLevel={userSubscriptionLevel}>
      <div className="flex min-h-screen flex-col">
        ...
        {children}
        <PremiumModal />
        <ExpiredModal isExpired={!!isActuallyExpired} />
      </div>
    </SubscriptionLevelProvider>
  );
}
