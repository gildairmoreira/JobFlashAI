...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#FAF9F7] border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            <Link href="/" className="inline-block mb-6">
              <span className="text-2xl font-extrabold text-stone-900 tracking-tight">JobFlashAI</span>
            </Link>

            <p className="text-stone-600 mb-6 max-w-md font-light leading-relaxed">
          ...
          {footerLinks.map((group, groupIndex) => (
            <div key={groupIndex} className="col-span-1">
              <h3 className="font-bold text-stone-900 mb-4">{group.title}</h3>
